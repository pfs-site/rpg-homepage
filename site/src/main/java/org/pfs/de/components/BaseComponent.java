...
public abstract class BaseComponent extends BaseHstComponent {
     ...
     * @return The component info object, or <code>null</code> if no
     * info is available.
     */
    @Override
    protected <T extends Object> T getComponentParametersInfo(HstRequest request) {
        //Method required for test mocking.
        return super.getComponentParametersInfo(request);
    }
}